...
public class ListViewCompatChemical extends ListView implements OnScrollListener {
	...
	public ListViewCompatChemical(Context context) {
		super(context);
		initView(context);
	}

	public ListViewCompatChemical(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public ListViewCompatChemical(Context context, AttributeSet attrs, int defStyle) {
