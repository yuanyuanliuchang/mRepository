...
import com.chimecal.ui.Utils;
import com.fragment.ChemicalFragment.MessageItem;
...
public class ListViewCompatChamecal extends ListView implements OnScrollListener {
	...
	public ListViewCompatChamecal(Context context) {
		super(context);
		initView(context);
	}

	public ListViewCompatChamecal(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public ListViewCompatChamecal(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(Context context) {
		...
		line = inflater.inflate(R.layout.my_listview_line, null);
