...
public class CircleLoader extends View {
	...
	public CircleLoader(Context context, AttributeSet attrs) {
		...
		circleRadius = (int) a.getDimension(R.styleable.circleloader_circleRadius,
				paramsCreator.getDefaultRadiusForCircle());
		circleStrokeWidth = (int) a.getDimension(R.styleable.circleloader_circleStrokeWidth,
				paramsCreator.getDefaultStrokeWidthForCircle());
